...
const posts = [
  {
    ...
    content: `Gianmarco began introducing blindfold training sessions for his styling team to help them hone their instinctual understanding of hair structure, texture, and weight distribution. "When you remove sight, your hands become your eyes," he explains. "You feel the thickness of the strand, you understand the bounce, and you cut based on structural balance rather than just visual shapes."

This unusual practice has gained popularity in Parsons Green, drawing clients who seek custom, signature layering that grows out beautifully. Gianmarco reassures: "Don't worry, we only use blindfolds during advanced training workshops, not on our clients! But the result is that our stylists develop an unmatched feel for hair shaping."

Through this sensory technique, Blush + Blow stylists learn to read hair density without relying solely on visual guidelines. By stripping away sight, a stylist must rely entirely on their fingers to gauge tension, thickness, and natural fall. It’s an exercise in pure structural styling that elevates our haircut precision to a world-class level.`,
  },
  {
    id: "mental-health",
...
Salons are increasingly becoming social hubs where friends can unwind together. Booking a pedicure side-by-side or enjoying signature blow-dries before a night out in Fulham is a great way to catch up. Taking this time to disconnect from screens and catch up in a relaxed, aesthetic environment releases serotonin and lowers stress levels.

At Blush + Blow, we design our spaces to encourage warm connection. We believe that self-care is a collaborative experience. Next time you plan a catch-up, skip the noisy coffee shop and spend an hour getting pampered together. Your mind—and your nails—will thank you.`,
  },
  {
    id: "cheap-special",
...
Gianmarco explains: "A cheap color service might look acceptable for the first week, but the damage shows as it washes out. A master colorist takes time to map your natural tones, formulate custom blends, and treat the strands. That is why special isn't cheap, and cheap isn't special."
...
BIAB is ideal for clients trying to grow out short or damaged nails. Over a few sessions, you'll notice your natural nails are longer, thicker, and healthier. Plus, it can be styled with any high-gloss gel shade or custom nail art. The result is a clean, structural manicure that stands up to the demands of London life while looking incredibly chic.`,
  },
  {
    ...
    content: `Finding the perfect hair colorist can be a journey of trial and error. But at Blush + Blow, we are proud to host some of the best hair colour specialists in West London.
...
Whether you're looking for a bright champagne blonde highlight set, a warm chestnut regrowth touch-up, or a dimensional sun-kissed balayage, our specialists in Parsons Green are dedicated to delivering high-performance, sustainable results. Visit us on the New King's Road and experience the difference of master colorists.`,
  },
];
          ...
          <div className="bg-white border border-[#EFECE6] rounded-lg overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-12 p-6 md:p-10 shadow-premium">
            ...
            <div className="w-full md:w-5/12 space-y-6">
              <div className="space-y-1">
                ...
                <h2 className="font-serif text-2xl md:text-3xl text-[#1E241B] font-light tracking-wide leading-tight uppercase">
                  {featured.title}
                </h2>
              </div>
